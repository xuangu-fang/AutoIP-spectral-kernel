...
class GPRLatent:
    ...
    def __init__(self,
        ...
        self.schedule = optax.cosine_decay_schedule(
            init_value=lr,
            decay_steps=int(trick_paras['nepoch'] / 100),
        )

        self.optimizer = optax.adam(learning_rate=self.schedule)
    ...
    def train(self, nepoch):
        ...
        print('gen fig ...')
        other_paras = '-cos_schedule_10'
        utils.make_fig_1d(self, params, log_dict, other_paras)
