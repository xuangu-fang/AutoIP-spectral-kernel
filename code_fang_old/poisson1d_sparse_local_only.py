...
if __name__ == '__main__':
    ...
    trick_list = [
        ...
        #     'llk_weight': 200.0, 'kernel': kernels_new.Local_Sparse_Matern52_Cos_1d, 'nepoch': 100000, 'freq_scale': 100, 'logdet': True},

        {'equation': 'poisson1d-x2_add_sinx', 'init_u_trick': init_func.zeros, 'num_u_trick': 1, 'Q': 30, 'lr': 1e-2,
            'llk_weight': 200.0, 'kernel': kernels_new.Local_Sparse_Matern52_Cos_1d, 'nepoch': 100000, 'freq_scale': 100, 'logdet': False, 'weights_normalize': utils.soft_max},

        {'equation': 'poisson1d-x2_add_sinx', 'init_u_trick': init_func.zeros, 'num_u_trick': 1, 'Q': 30, 'lr': 1e-2,
            'llk_weight': 200.0, 'kernel': kernels_new.Local_Sparse_Matern52_Cos_1d, 'nepoch': 100000, 'freq_scale': 100, 'logdet': True, 'weights_normalize': utils.soft_max},
