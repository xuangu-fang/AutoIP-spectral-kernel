...
class GPRLatent:
    ...
    def loss(self, params, key):
        ...
        eta = params['eta']
        eta = eta.sum(axis=1).reshape(-1, 1)  # sum over trick
        ...
        Kinv_u = jnp.linalg.solve(L.T, eta)

        u = jnp.matmul(L, eta)

        #  log prior
        log_prior = - 0.5*jnp.sum(eta)
    ...
    def train(self, nepoch):
        ...
        params = {
            ...
            "eta": self.trick_paras['init_u_trick'](self, self.trick_paras),
        ...
        print('gen fig ...')
        utils.make_fig_1d(self, params, log_dict, '-whitening')
...
if __name__ == '__main__':
    ...
    trick_list = [
        ...
        {'equation': 'poisson1d-x2_add_sinx', 'init_u_trick': init_func.randn, 'num_u_trick': 1, 'Q': 30,
            'lr': 1e-2, 'llk_weight': 100.0, 'kernel': kernels_new.Matern52_Cos_1d, 'nepoch': 100000, 'freq_scale': 100, 'logdet': False},
        {'equation': 'poisson1d-mix-sin', 'init_u_trick': init_func.randn, 'num_u_trick': 1, 'Q': 30,
            'lr': 1e-2, 'llk_weight': 100.0, 'kernel': kernels_new.Matern52_Cos_1d, 'nepoch': 100000, 'freq_scale': 100, 'logdet': False},
    ]
