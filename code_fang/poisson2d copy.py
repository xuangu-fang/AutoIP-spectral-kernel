...
if __name__ == '__main__':
    ...
    trick_list = [
                {'equation':'poisson2d-mix-sincos' ,'init_u_trick': init_func.zeros, 'num_u_trick': 1, 'Q': 30, 'lr': 1e-2, 'llk_weight':100.0, 'kernel' : kernels_new.Matern52_Cos_add_Matern_1d, 'nepoch': 100},  
    ]
