...
class GPRLatent:
    ...
    def train(self, nepoch):
        ...
        log_dict = {'loss_list': loss_list, 'err_list': err_list, 'epoch_list': epoch_list, 'w_list_k1': w_list_k1, 'ls_list_k1': ls_list_k1,
                    'freq_list_k1': freq_list_k1, 'w_list_k2': w_list_k2, 'ls_list_k2': ls_list_k2, 'freq_list_k2': freq_list_k2}

        print('gen fig ...')
        other_paras = '-non-zero-freq'
        utils.make_fig_2d(self, params, log_dict, other_paras)
...
if __name__ == '__main__':
    ...
    trick_list = [
        # {'equation': 'allencahn2d-mix-sincos-high', 'init_u_trick': init_func.zeros, 'num_u_trick': 1,
        #     'Q': 50, 'lr': 1e-2, 'llk_weight': 500.0, 'kernel': kernels_new.Matern52_Cos_1d, 'nepoch': 100000, 'freq_scale': 100, 'logdet': True},

        {'equation': 'allencahn2d-mix-sincos', 'init_u_trick': init_func.zeros, 'num_u_trick': 1,
            'Q': 30, 'lr': 1e-2, 'llk_weight': 1000.0, 'kernel': kernels_new.Matern52_Cos_1d, 'nepoch': 4000000, 'freq_scale': 50, 'logdet': True},
    ]
